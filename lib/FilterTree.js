...
var FilterTree = (function (_Component) {
  _inherits(FilterTree, _Component);
  ...
  _createClass(FilterTree, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (!(0, _Tree.treesAreEqual)(this.props.treeNodes, nextProps.treeNodes)) {
        this.originalTree = _lodash2.default.clone(this.props.treeNodes);
      }
    }
  }, {
    ...
    value: function handleTypeaheadChange(event) {
      ...
      var toggled = (0, _Tree.getToggledTree)(this.originalTree, filterTerm);
    ...
    value: function render() {
      ...
      var onSelectionsChange = _props.onSelectionsChange;
      var selectedTerms = _props.selectedTerms;
      var includeParentNodes = _props.includeParentNodes;
      var filterTerm = _props.filterTerm;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Tree2.default, { treeNodes: treeNodes,
